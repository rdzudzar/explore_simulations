# scientific_colourmaps: acton_map, bamako_map, batlow_map, berlin_map, bilbao_map
#                 		 broc_map, buda_map, cork_map, davos_map, devon_map, grayC_map, hawaii_map
#			 	  		 imola_map, lajolla_map, lapaz_map, lisbon_map, nuuk_map, oleron_map,
#				  		 oslo_map, roma_map, tofino_map, tokyo_map, turku_map, vik_map
...
cm_data_devon = [[0.17103, 0.1004, 0.29978],      
...
cm_data_acton = [[0.18063, 0.12992, 0.30024],      
...
cm_data_bamako = [[0.0011753, 0.25004, 0.3],      
...
cm_data_batlow = [[0.0035963, 0.099991, 0.3501],      
...
cm_data_berlin = [[0.62108, 0.69018, 0.99951],      
...
cm_data_broc = [[0.17081, 0.10027, 0.29985],      
...
cm_data_buda = [[0.70015, 0.0027445, 0.70061],      
...
cm_data_cork = [[0.171, 0.10033, 0.29984],      
...
cm_data_davos = [[0, 0.019685, 0.29201],      
           [0, 0.027123, 0.29748],      
           [0, 0.034324, 0.30295],      
...
cm_data_hawaii = [[0.55054, 0.006842, 0.45198],      
...
cm_data_imola = [[0.10144, 0.20011, 0.70019],      
...
cm_data_lajolla = [[0.99983, 0.99974, 0.79991],      
...
cm_data_lapaz = [[0.10352, 0.047787, 0.39353],      
...
cm_data_lisbon = [[0.90019, 0.89986, 0.99991],      
...
cm_data_nuuk = [[0.018013, 0.35076, 0.55062],      
...
cm_data_oleron = [[0.10105, 0.15003, 0.35027],      
...
cm_data_oslo = [[0.0036704, 0.0050824, 0.0024536],      
...
cm_data_roma = [[0.49684, 0.099626, 0],      
...
cm_data_tofino = [[0.87044, 0.84978, 0.99992],      
...
cm_data_tokyo = [[0.10387, 0.056805, 0.20243],      
...
cm_data_turku = [[6.3216e-05, 5.1671e-06, 3.583e-05],      
...
vik_map = LinearSegmentedColormap.from_list('vik', cm_data_vik)      
turku_map = LinearSegmentedColormap.from_list('turku', cm_data_turku)            
tokyo_map = LinearSegmentedColormap.from_list('tokyo', cm_data_tokyo)            
tofino_map = LinearSegmentedColormap.from_list('tofino', cm_data_tofino)            
roma_map = LinearSegmentedColormap.from_list('roma', cm_data_roma)            
oslo_map = LinearSegmentedColormap.from_list('oslo', cm_data_oslo)            
oleron_map = LinearSegmentedColormap.from_list('oleron', cm_data_oleron)            
nuuk_map = LinearSegmentedColormap.from_list('nuuk', cm_data_nuuk)            
lisbon_map = LinearSegmentedColormap.from_list('lisbon', cm_data_lisbon)      
lapaz_map = LinearSegmentedColormap.from_list('lapaz', cm_data_lapaz)      
lajolla_map = LinearSegmentedColormap.from_list('lajolla', cm_data_lajolla)      
imola_map = LinearSegmentedColormap.from_list('imola', cm_data_imola)      
hawaii_map = LinearSegmentedColormap.from_list('hawaii', cm_data_hawaii)      
grayC_map = LinearSegmentedColormap.from_list('grayC', cm_data_grayC)      
davos_map = LinearSegmentedColormap.from_list('davos', cm_data_davos)      
cork_map = LinearSegmentedColormap.from_list('cork', cm_data_cork)      
buda_map = LinearSegmentedColormap.from_list('buda', cm_data_buda)      
broc_map = LinearSegmentedColormap.from_list('broc', cm_data_broc)      
bilbao_map = LinearSegmentedColormap.from_list('bilbao', cm_data_bilbao)      
berlin_map = LinearSegmentedColormap.from_list('berlin', cm_data_berlin)      
batlow_map = LinearSegmentedColormap.from_list('batlow', cm_data_batlow)      
bamako_map = LinearSegmentedColormap.from_list('bamako', cm_data_bamako)            
acton_map = LinearSegmentedColormap.from_list('acton', cm_data_acton)
devon_map = LinearSegmentedColormap.from_list('devon', cm_data_devon)      



list_scientific_colourmaps = np.array([acton_map, bamako_map, batlow_map, berlin_map, bilbao_map, broc_map, buda_map, cork_map, davos_map, devon_map, grayC_map, hawaii_map, imola_map, lajolla_map, lapaz_map, lisbon_map, nuuk_map, oleron_map,oslo_map, roma_map, tofino_map, tokyo_map, turku_map, vik_map])
list_names = np.array(['acton_map', 'bamako_map', 'batlow_map', 'berlin_map', 'bilbao_map', 'broc_map', 'buda_map',
 'cork_map', 'davos_map', 'devon_map', 'grayC_map', 'hawaii_map', 'imola_map', 'lajolla_map', 'lapaz_map', 
 'lisbon_map', 'nuuk_map', 'oleron_map', 'oslo_map', 'roma_map', 'tofino_map', 'tokyo_map', 'turku_map', 
 'vik_map'])
